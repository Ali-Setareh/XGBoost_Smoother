...
create_S_from_gbtregressor = function(model,leaf_indices_train,leaf_indices_test,output_dir, save_output, compact = FALSE){
...
get_xgboost_weights = function(model,dtrain,dtest,save_output = FALSE, output_dir = NULL){
  ...
  smoothers = create_S_from_gbtregressor(model,leaf_indices_train,leaf_indices_test,save_output = save_output,output_dir = output_dir)
